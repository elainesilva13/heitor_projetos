...
print(f"Pegamos da terceira até a quinta letra de uma palavra assim: qualquer_palavra[0:3] => {qualquer_palavra[2:5]}")
print(f"Pegamos da terceira até a sétima letra de uma palavra assim: qualquer_palavra[0:3] => {qualquer_palavra[2:7]}")
print(f"Pegamos da terceira até a última letra de uma palavra assim: qualquer_palavra[0:3] => {qualquer_palavra[2:]}")
print(f"Pegamos da primeira até a última letra de uma palavra assim: qualquer_palavra[0:3] => {qualquer_palavra[:2]}")
print(f"Pegamos a última letra de uma palavra assim: qualquer_palavra[0:3] => {qualquer_palavra[-1]}")
...
string_sem_colchete = string_assim.replace("[", '')  #replace substitui caracteres
